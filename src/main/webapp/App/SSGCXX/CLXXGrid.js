Ext.define('App.SSGCXX.CLXXGrid.List.Model', {
...
Ext.define('App.SSGCXX.CLXXGrid.List', {
	...
	initComponent : function() {
		...
		this.store = Ext.create('Ext.data.Store', {
					model : 'App.SSGCXX.CLXXGrid.List.Model',		
					autoLoad : false
				});
...
Ext.define('App.SSGCXX.CLXXGrid', {
	...
	initComponent : function() {
		...
		this.list = Ext.create('App.SSGCXX.CLXXGrid.List', {
					width : '100%',
					height : '100%',
					listeners : {
						scope : this,
		...
		vme.inserttimerid = setTimeout(function() {
					...
					for (var i = vnewrecords.length - 1; i >= 0; i--) {
						...
						vrecords.push(Ext.create(
								'App.SSGCXX.CLXXGrid.List.Model', {
									JGSJ : vrec.jGSJ,
				 					HPHM : vrec.hPHM,
				 					XSFX : vrec.xSFX,
				 					HPYS : vrec.hPYS,
