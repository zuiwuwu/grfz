...
Ext.define('App.Common.tab.Tab', {
    ...
    */
    ...
    initComponent: function () {
        var me = this;
        me.iconCls = me.tabCls + 'tab-btn-icon';
        me.closeElOverCls = me.tabCls + 'tab-close-btn-over';
    ...
    beforeRender: function () {
        var me = this,
            tabBar = me.up('sptabbar'),
            tabPanel = me.up('sptabpanel');
