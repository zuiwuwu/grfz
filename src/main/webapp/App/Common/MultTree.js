...
*/
Ext.define('App.Common.MultTree', {
    extend: 'Ext.panel.Table',
    alias: 'widget.multtree',
    //alternateClassName: ['Ext.tree.TreePanel', 'Ext.TreePanel'],
    requires: ['App.Common.MultTreeView', 'Ext.selection.TreeModel', 'App.Common.MultTreeColumn', 'Ext.data.TreeStore'],
    viewType: 'multtreeview',
    selType: 'treemodel',
    ...
    */
    ...
    setAllChecked: function (checked) {
        this.getView().setAllChecked(checked);
    },
    setChecked: function (checkedrec) {
        this.getView().setChecked(checkedrec);
    },
