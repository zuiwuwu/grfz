Ext.define('App.Common.DateBoxYearPicker', {
    ...
    alternateClassName: 'Ext.DateBoxYearPicker',
    ...
    onYearClick: function(target, isDouble){
        var me = this;
        me.value = me.activeYear + me.resolveOffset(me.years.indexOf(target), me.yearOffset);
        me.updateBody();
