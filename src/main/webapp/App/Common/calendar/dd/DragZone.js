 ...
 */
Ext.define('App.Common.calendar.dd.DragZone', {
    extend: 'Ext.dd.DragZone',

    requires: [
        'App.Common.calendar.dd.StatusProxy'
    ],
    ...
    constructor: function(el, config) {
        if (!App.Common.calendar._statusProxyInstance) {
            App.Common.calendar._statusProxyInstance = new App.Common.calendar.dd.StatusProxy();
        }
        this.proxy = App.Common.calendar._statusProxyInstance;
