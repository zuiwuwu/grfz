 ...
 */
Ext.define('App.Common.calendar.dd.DayDropZone', {
    extend: 'App.Common.calendar.dd.DropZone',
    requires: [
    ...
    onNodeOver: function(n, dd, e, data) {
        ...
        if (data.type == 'caldrag') {
            ...
            curr = App.Common.calendar.util.Date.copyTime(n.date, this.dragCreateDt);
            this.dragStartDate = App.Common.calendar.util.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || App.Common.calendar.util.Date.max(this.dragCreateDt, curr);
            ...
            if (data.type == 'eventresize') {
                ...
                curr = App.Common.calendar.util.Date.copyTime(n.date, this.resizeDt);
                start = App.Common.calendar.util.Date.min(data.eventStart, curr);
                end = App.Common.calendar.util.Date.max(data.eventStart, curr);
