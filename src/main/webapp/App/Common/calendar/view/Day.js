/**
 * @class App.Common.calendar.view.Day
 * @extends Ext.container.Container
 * <p>Unlike other calendar views, is not actually a subclass of {@link App.Common.calendar.view.AbstractCalendar AbstractCalendar}.
 * Instead it is a {@link Ext.container.Container Container} subclass that internally creates and manages the layouts of
 * a {@link App.Common.calendar.DayHeaderView DayHeaderView} and a {@link App.Common.calendar.DayBodyView DayBodyView}. As such
 ...
 */
Ext.define('App.Common.calendar.view.Day', {
    extend: 'Ext.container.Container',
    alias: 'widget.dayview',
    
    requires: [
        'App.Common.calendar.view.AbstractCalendar',
        'App.Common.calendar.view.DayHeader',
        'App.Common.calendar.view.DayBody'
    ],
    ...
    initComponent : function(){
        ...
        cfg.ongetDayBodyTemplateEventData = this.ongetDayBodyTemplateEventData;
        cfg.fieldEventId = this.fieldEventId;
        cfg.fieldReminder = this.fieldReminder;
        cfg.fieldStartDate = this.fieldStartDate;
        cfg.fieldEndDate = this.fieldEndDate;
        cfg.fieldIsAllDay = this.fieldIsAllDay;
        cfg.fieldTitle = this.fieldTitle;
        cfg.enableDD = this.enableDD;
