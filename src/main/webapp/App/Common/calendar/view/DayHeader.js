/**
 * @class App.Common.calendar.view.DayHeader
 * @extends App.Common.calendar.MonthView
 ...
 * which aggregates this class and the {@link App.Common.calendar.DayBodyView DayBodyView} into the single unified view
 * presented by {@link App.Common.calendar.CalendarPanel CalendarPanel}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('App.Common.calendar.view.DayHeader', {
    extend: 'App.Common.calendar.view.Month',
    alias: 'widget.dayheaderview',

    requires: [
        'App.Common.calendar.template.DayHeader'
    ],
     ...
     * @param {App.Common.calendar.DayBodyView} this
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new App.Common.calendar.template.DayHeader({
                id: this.id,
