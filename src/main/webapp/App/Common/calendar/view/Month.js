/**
 * @class App.Common.calendar.view.Month
 * @extends App.Common.calendar.CalendarView
 ...
 */
Ext.define('App.Common.calendar.view.Month', {
    extend: 'App.Common.calendar.view.AbstractCalendar',
    alias: 'widget.monthview',

    requires: [
        'Ext.XTemplate',
        'App.Common.calendar.template.Month',
        'App.Common.calendar.util.WeekEventRenderer',
        'App.Common.calendar.view.MonthDayDetail'
    ],
    ...
    * True to display an extra column before the first day in the calendar that links to the {@link App.Common.calendar.WeekView view}
    ...
    */
    ...
    initComponent: function () {
        ...
        this.addEvents({
            ...
            * @param {App.Common.calendar.view.Month} this
    ...
    initDD: function () {
        ...
        this.dragZone = new App.Common.calendar.dd.DragZone(this.el, cfg);
        this.dropZone = new App.Common.calendar.dd.DropZone(this.el, cfg);
    },
    ...
    afterRender: function () {
        if (!this.tpl) {
            this.tpl = new App.Common.calendar.template.Month({
                id: this.id,
    ...
    getTemplateEventData: function (evt) {
        if (this.ongetTemplateEventData) {
            var selector = this.getEventSelectorCls(evt[this.fieldEventId]);
            return Ext.callback(this.ongetTemplateEventData, this.scope || this, [evt, selector]);
        }
    },
    ...
    renderItems: function () {
        App.Common.calendar.util.WeekEventRenderer.render({
    ...
    getDayAt: function (x, y) {
        var box = this.el.getBox(),
            ...
            days = (dayT * 7) + dayL,
            dt = App.Common.calendar.util.Date.add(this.viewStart, { days: days });
        return {
            date: dt,
            el: this.getDayEl(dt)
        };
    ...
    onClick: function (e, t) {
        ...
        if (App.Common.calendar.view.Month.superclass.onClick.apply(this, arguments)) {
