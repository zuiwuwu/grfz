/**
 * @class App.Common.calendar.template.Month
 * @extends Ext.XTemplate
 * <p>This is the template used to render the {@link App.Common.calendar.template.Month MonthView}. Internally this class defers to an
 ...
 */
Ext.define('App.Common.calendar.template.Month', {
    ...
    constructor: function(config){
        ...
        this.weekTpl = new App.Common.calendar.template.BoxLayout(config);
    ...
    applyTemplate : function(o){
        var days = [],
            ...
            dt = o.viewStart,
            D = App.Common.calendar.util.Date;
