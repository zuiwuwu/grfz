Ext.define('App.Common.calendar.form.Combo', {
...
Ext.define('App.Common.calendar.form.EventWindow', {
    ...
    requires: [
        ...
        'App.Common.calendar.data.EventModel',
        'App.Common.calendar.data.EventMappings'
    ],

    constructor: function (config) {
        this.calendarField = Ext.create('App.Common.calendar.form.Combo', {
            fieldLabel: '巡检员',
            anchor: '100%',
            allowBlank: false,
            name: App.Common.calendar.data.EventMappings.CalendarId.name,
            itemId: 'calendar',
            url: '../XJYMng/ListPBXJY'
        });
        var formPanelCfg = {
            xtype: 'form',
            fieldDefaults: {
            ...
            //             {
            //                 itemId: 'title',
            //                 name: App.Common.calendar.data.EventMappings.Title.name,
            //                 fieldLabel: '巡检员',
            //                 xtype: 'textfield',
            //                 allowBlank: false,
            //                 emptyText: '',
        ...
        },
            {
                xtype: 'textfield',
                itemId: 'notes',
                name: App.Common.calendar.data.EventMappings.Notes.name,
                anchor: '100%',
                fieldLabel: '备注'
            }]
    };
...
initComponent: function () {
    ...
    this.addEvents({
        ...
        * @param {App.Common.calendar.form.EventWindow} this
        * @param {App.Common.calendar.EventRecord} rec The new {@link App.Common.calendar.EventRecord record} that was added
        */
        eventadd: true,
        /**
        * @event eventupdate
        ...
        * @param {App.Common.calendar.form.EventWindow} this
        * @param {App.Common.calendar.EventRecord} rec The new {@link App.Common.calendar.EventRecord record} that was updated
        */
        eventupdate: true,
        /**
        * @event eventdelete
        ...
        * @param {App.Common.calendar.form.EventWindow} this
        * @param {App.Common.calendar.EventRecord} rec The new {@link App.Common.calendar.EventRecord record} that was deleted
        */
        eventdelete: true,
        /**
        * @event eventcancel
        ...
        * @param {App.Common.calendar.form.EventWindow} this
        * @param {App.Common.calendar.EventRecord} rec The new {@link App.Common.calendar.EventRecord record} that was canceled
        */
        eventcancel: true,
        /**
        * @event editdetails
        * Fires when the user selects the option in this window to continue editing in the detailed edit form
        * (by default, an instance of {@link App.Common.calendar.EventEditForm}. Handling code should hide this window
        * and transfer the current event record to the appropriate instance of the detailed form by showing it
        * and calling {@link App.Common.calendar.EventEditForm#loadRecord loadRecord}.
        * @param {App.Common.calendar.form.EventWindow} this
        * @param {App.Common.calendar.EventRecord} rec The {@link App.Common.calendar.EventRecord record} that is currently being edited
        */
        editdetails: true
    });
},
...
show: function (o, animateTarget) {
    ...
    var me = this,
            ...
            M = App.Common.calendar.data.EventMappings;
    ...
    if (o.data) {
        ...
        var start = o[M.StartDate.name],
                end = o[M.EndDate.name] || App.Common.calendar.util.Date.add(start, { hours: 1 });

        rec = Ext.create('App.Common.calendar.data.EventModel');
        rec.data[M.StartDate.name] = start;
        rec.data[M.EndDate.name] = end;
        rec.data[M.IsAllDay.name] = !!o[M.IsAllDay.name] || start.getDate() != App.Common.calendar.util.Date.add(end, { millis: 1 }).getDate();

        f.reset();
        f.loadRecord(rec);
    }
    if (this.calendarField) {
        this.calendarField.setValue(rec.data[M.CalendarId.name].toString());
    }
...
updateRecord: function (record, keepEditing) {
    var fields = record.fields,
            ...
            M = App.Common.calendar.data.EventMappings,
            obj = {};
    values.Title = this.calendarField.getRawValue();
