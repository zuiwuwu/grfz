/**
 * @class App.Common.calendar.form.EventDetails
 ...
 * calendar components. It is also configured to automatically bind records of type {@link App.Common.calendar.EventRecord}
 ...
 */
Ext.define('App.Common.calendar.form.EventDetails', {
    extend: 'Ext.form.Panel',
    alias: 'widget.eventeditform',
    
    requires: [
        'App.Common.calendar.form.field.DateRange',
        'App.Common.calendar.form.field.ReminderCombo',
        'App.Common.calendar.data.EventMappings',
        'App.Common.calendar.form.field.CalendarCombo'
    ],
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {App.Common.calendar.form.EventDetails} this
        ...
        this.dateRangeField = new App.Common.calendar.form.field.DateRange({
            fieldLabel: 'When',
            singleLine: false,
            anchor: '90%'
        });
        this.reminderField = new App.Common.calendar.form.field.ReminderCombo({
            name: 'Reminder',
            anchor: '70%'
        });
        ...
        this.locationField = new Ext.form.Text({
            fieldLabel: 'Location',
            name: App.Common.calendar.data.EventMappings.Location.name,
            anchor: '100%'
        });
        this.urlField = new Ext.form.Text({
            fieldLabel: 'Web Link',
            name: App.Common.calendar.data.EventMappings.Url.name,
            anchor: '100%'
        });
        ...
        if (this.calendarStore) {
            this.calendarField = new App.Common.calendar.form.field.CalendarCombo({
    ...
    loadRecord: function(rec){
        ...
        if(this.calendarStore){
            this.form.setValues({
                'calendar': rec.data[App.Common.calendar.data.EventMappings.CalendarId.name]
            });
        }
