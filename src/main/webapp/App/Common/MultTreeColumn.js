...
* @private
*/
Ext.define('App.Common.MultTreeColumn', {
    extend: 'Ext.grid.column.Column',
    alias: 'widget.multtreecolumn',
    ...
    cellTpl: [
        ...
        '<tpl if="checked !== null">',
            '<input type="button" role="checkbox" <tpl if="checked === true||checked !== \'none\'">aria-checked="true" </tpl>',
                'class="{childCls} {checkboxCls}<tpl if="checked === true||checked === \'all\'"> {checkboxCls}-checked</tpl><tpl else if="checked === \'part\'"> {checkboxCls}-checkedpart</tpl>"/>',
        '</tpl>',
