...
*/
Ext.define('App.Common.grid.CheckboxModel', {
    alias: 'selection.spcheckboxmodel',
    ...
    */
    onHeaderClick: function (headerCt, header, e) {
        if (header.isCheckerHd) {
            e.stopEvent();
            var me = this,
                isChecked = header.el.hasCls(me.gridCls + 'grid-hd-checker-on');
    ...
    */
    getHeaderConfig: function () {
        ...
        return {
            ...
            menuDisabled: true,
            dataIndex: '',
            cls: showCheck ? me.gridCls + 'column-header-checkbox ' : '',
    ...
    */
    renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
        var baseCSSPrefix = this.gridCls;
