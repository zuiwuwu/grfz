Ext.define('App.Common.grid.DragZone', {
    ...
    constructor: function (headerCt) {
        ...
        if(headerCt.colHeaderSelector)
            this.colHeaderSelector = headerCt.colHeaderSelector;
        if(headerCt.colInnerSelector)
            this.colInnerSelector = headerCt.colInnerSelector;
