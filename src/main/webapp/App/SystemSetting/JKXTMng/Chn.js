Ext.define('App.SystemSetting.JKXTMng.Chn', {
    ...
    onSave: function () {
        ...
        for (var i = 0; i < vme.store.getCount(); i++) {
            var rec = vme.store.getAt(i);
            values.push({ GLOBALID: rec.get('GLOBALID'), SEL: rec.get('SEL'), JKXTBH: vme.commonparams.JKXTBH });
        }
