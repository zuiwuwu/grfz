Ext.define('App.SystemSetting.YWSvr.UserInfo.Model', {
...
//定义编辑对话框
Ext.define('App.SystemSetting.YWSvr.UserInfo', {
                ...
                callback: function (options, success, response) {
                    if (success) {
                        ...
                        if (v) {
                            ...
                            form.loadRecord(Ext.create('App.SystemSetting.YWSvr.UserInfo.Model', v));
                        }
                    }
                    else {
                        alert(SPLanguage.getMessage("Net_Error"));
