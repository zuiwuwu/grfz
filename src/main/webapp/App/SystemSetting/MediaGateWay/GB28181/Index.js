Ext.define('App.SystemSetting.MediaGateWay.GB28181.Index', {
    ...
    initComponent: function () {
        ...
        this.vwork = Ext.create('Ext.Container', {
            region: 'center',
            layout: 'fit',
            items: [Ext.create('App.SystemSetting.MediaGateWay.GB28181.svr',{
    ...
    afterRender: function () {
        ...
        var menus = [
        {
        	...
        	ChildMenu: [
        	{
        		MenuName: '下级网关管理',
        		MenuIcon: 'icon-gnxx',
        		MenuAction: 'App.SystemSetting.MediaGateWay.GB28181.svr'
        	},
        	{
        		MenuName: '设备管理',
        		MenuIcon: 'icon-gnxx',
