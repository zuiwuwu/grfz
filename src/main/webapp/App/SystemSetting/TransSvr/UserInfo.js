Ext.define('App.SystemSetting.TransSvr.UserInfo.Model', {
...
//定义编辑对话框
Ext.define('App.SystemSetting.TransSvr.UserInfo', {
    ...
    initComponent: function () {
        ...
        if (typeof this.wizard.rightParams.ID == 'undefined') {
            ...
            this.pswfield = Ext.create('App.Common.CheckBoxFieldset', {
                flex: 1,
                title: SPLanguage.getMessage("XGMM"),
                layout: 'anchor',
                checkboxName: 'MODIFYPSW',
                items: [{
                    width: 300,
                    labelWidth: 80,
                    xtype: 'textfield',
                ...
                callback: function (options, success, response) {
                    if (success) {
                        ...
                        if (!v.success)
                            ...
                            vme.wizard.onSetWizardItemActive('recchn');
                        }
                    }
                    else {
                ...
                callback: function (options, success, response) {
                    if (success) {
                        ...
                        if (v) {
                            ...
                            form.loadRecord(Ext.create('App.SystemSetting.TransSvr.UserInfo.Model', v));
                        }
                    }
                    else {
                        alert(SPLanguage.getMessage("Net_Error"));
