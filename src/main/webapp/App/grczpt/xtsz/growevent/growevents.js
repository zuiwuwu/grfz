Ext.define('App.grczpt.xtsz.growevent.growevents', {
			                       ...
			                       items: [
			                         {
			                           ...
			                           handler: function (grid, rowIndex, colIndex) {
			                               ...
			                               Ext.create('App.grczpt.xtsz.growevent.growContext', {
			                           ...
			                           handler: function (grid, rowIndex, colIndex) {
			                               ...
			                               Ext.create('App.grczpt.xtsz.growevent.editGrow', {
...
//								url : url, // 查询案件详细信息
	...
	onAddClick : function() {	
		...
		console.log(store)
			...
			Ext.create('App.grczpt.xtsz.growevent.addGrow', {									
				ss : store				
					}).show(store);			
			function refresh(){
