Ext.define('App.grfz.khgl.fjbmejkh.index.list', {
	extend:'App.framework.listfrm',
	url:'../KHGL/getFJBMEJKHLists',
...
Ext.define('App.grfz.khgl.fjbmejkh.index.gridButton', {
...
Ext.define('App.grfz.khgl.fjbmejkh.index', {
    extend: 'Ext.container.Container',
    layout: 'vbox',
    border: 0,
	width :'100%',
	...
	initComponent : function() {
		var me=this;
		me.list=Ext.create('App.grfz.khgl.fjbmejkh.index.list', {
			width: '100%',
			flex: 1
	        });
		me.gridButton = Ext.create('App.grfz.khgl.fjbmejkh.index.gridButton', {
			list:me.list,
		});
