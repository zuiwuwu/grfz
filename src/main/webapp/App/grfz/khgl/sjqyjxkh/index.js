Ext.define('App.grfz.khgl.sjqyjxkh.index.list', {
	extend:'App.framework.listfrm',
	url:'../KHGL/getSJQYJXKHLists',
...
Ext.define('App.grfz.khgl.sjqyjxkh.index.gridButton', {
...
Ext.define('App.grfz.khgl.sjqyjxkh.index', {
    extend: 'Ext.container.Container',
    layout: 'vbox',
    border: 0,
	width :'100%',
	...
	initComponent : function() {
		var me=this;
		me.list=Ext.create('App.grfz.khgl.sjqyjxkh.index.list', {
			width: '100%',
			flex: 1
	        });
		me.gridButton = Ext.create('App.grfz.khgl.sjqyjxkh.index.gridButton', {
			list:me.list,
		});
