Ext.define('App.grfz.khgl.gwyndkh.index.list', {
...
Ext.define('App.grfz.khgl.gwyndkh.index.gridButton', {
...
Ext.define('App.grfz.khgl.gwyndkh.index', {
    extend: 'Ext.container.Container',
    layout: 'vbox',
    border: 0,
	width :'100%',
	...
	initComponent : function() {
		var me=this;
		me.list=Ext.create('App.grfz.khgl.gwyndkh.index.list', {
			width: '100%',
			flex: 1
	        });
		me.gridButton = Ext.create('App.grfz.khgl.gwyndkh.index.gridButton', {
			list:me.list,
		});
