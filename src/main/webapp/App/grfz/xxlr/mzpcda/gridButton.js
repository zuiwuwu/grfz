Ext.define('App.grfz.xxlr.mzpcda.gridButton', {
	...
	initComponent : function() {
   	...
   	me.callParent(arguments);
		...
		addxx: function(btn){
			var vme = this;
			 Ext.create('App.grfz.xxlr.mzpcda.addDlg', {
		            modifyMod: false,
		            url: '../MZPCGL/importMZXX',
		            listeners: {
		                scope: this,
		...
		onDelClick:function(){
					this.mzpcxx.onDelClick();  	
					    },
					    
					    onSearch : function() {
							var store = this.mzpcxx.getStore();
