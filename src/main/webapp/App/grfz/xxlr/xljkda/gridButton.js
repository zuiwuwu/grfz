Ext.define('App.grfz.xxlr.xljkda.gridButton', {
	...
	initComponent : function() {
   	...
   	me.callParent(arguments);
		...
		addxx: function(btn){
			var vme = this;
			 Ext.create('App.grfz.xxlr.xljkda.addDlg', {
		            modifyMod: false,
		            url: '../XLJKGL/importJKXX',
		            listeners: {
		                scope: this,
		...
		onDelClick:function(){
					this.xljkxx.onDelClick();  	
					    },
					    
					    onSearch : function() {
							var store = this.xljkxx.getStore();
